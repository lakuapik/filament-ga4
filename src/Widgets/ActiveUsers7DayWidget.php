...
class ActiveUsers7DayWidget extends Widget
{
    use Traits\ActiveUsers;
    use Traits\CanViewWidget;

    protected static string $view = 'filament-ga4::widgets.active-users-7-day-widget';
    ...
    {
        return __('filament-ga4::widgets.7_day_active_users');
    }
    ...
    {
        $lookups = [
            '5' => fn () => $this->getActiveUsers('active7DayUsers', 5),
            '10' => fn () => $this->getActiveUsers('active7DayUsers', 10),
            '15' => fn () => $this->getActiveUsers('active7DayUsers', 15),
        ];
